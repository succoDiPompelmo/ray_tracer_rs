...
use crate::{
    core::tuples::Tuple, materials::patterns::Pattern, scenarios::lights::PointLight, shapes::Shape,
};
...
mod tests {
    ...
    use crate::{margin::Margin, materials::patterns::PatternsKind, shapes::spheres::Sphere};
